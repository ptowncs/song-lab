public class Main {
    public static void main(String[] args){
        ...
        System.out.println("Total Number of Songs: " + mySongs.length);
        ...
        System.out.println("Number of songs with danceability greater than 0.8: " +  r.getGreatestDanceability(mySongs, 0.8));
